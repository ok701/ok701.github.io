...
export const projects: Project[] = [
  {
    ...
    category: 'Robotics',
    period: '2023 – 2025',
    paperUrl: '#', // TODO: Update link when published
    links: [
      {
        label: 'Paper (IROS 2026)',
        url: '#',
        type: 'paper',
      },
    ],
  },
  {
    ...
    thumbnail: galleries['mobile-manipulator']?.[0] || '/projects/mobile-manipulator/01.svg',
    gallery: galleries['mobile-manipulator'] || ['/projects/mobile-manipulator/01.svg'],
    description:
  ...
  },
  {
    ...
    thumbnail: galleries['disturbance-compensation']?.[0] || '/projects/disturbance-compensation/01.svg',
    gallery: galleries['disturbance-compensation'] || ['/projects/disturbance-compensation/01.svg'],
    description:
  ...
  },
  {
    ...
    thumbnail: galleries['motor-control']?.[0] || '/projects/motor-control/01.svg',
    gallery: galleries['motor-control'] || ['/projects/motor-control/01.svg'],
    description:
  ...
  },
  {
    ...
    thumbnail: galleries['embedded-control']?.[0] || '/projects/embedded-control/01.svg',
    gallery: galleries['embedded-control'] || ['/projects/embedded-control/01.svg'],
    description:
